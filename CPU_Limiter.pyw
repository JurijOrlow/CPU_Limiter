...
okno = tk.Tk()
okno.title("CPU Limiter by JurijOrlow")
...
output_frame = tk.Frame(okno, width=300, height=50, background='grey')
...
button_frame = tk.Frame(okno, width=300, height=250, background='light blue')
...
output_textbox = tk.Entry(output_frame, font=("Arial", 25), state=tk.DISABLED, disabledbackground='white', background='white', fg='black', justify='center') #tworzenie pola tekstowego, ktorego rodzicem jest output_frame
...
copyright_textbox = tk.Label(text="Created by: JurijOrlow (github.com/JurijOrlow), 2021")
copyright_textbox.grid(sticky=tk.NSEW)
